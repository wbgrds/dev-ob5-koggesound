	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 heading">
                <i class="fa fa-user"></i>				<h2 class="bigtitle"><span>About</span></h2>                <p class="subtitle">Donec nec justo eget felis facilisis fermentum. Aliquam dignissim felis auctor ultrices ut elementum.</p>			</div>
			<div class="col-md-12">
